...
class GenerateManga:
    ...
    def generate_ai_response(self, prompt):
        system_message = "You are a helpful assistant. Your task is to generate a detailed response based on the user's input. Please provide a comprehensive answer in the specified JSON format."
        ...
        response = client.chat.completions.create(
            model="cognitivecomputations/dolphin3.0-r1-mistral-24b:free", messages=messages
        )
    ...
    def stable_diff(self, image_prompt, image_name, cfg, step):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if balance_err in error_message:
